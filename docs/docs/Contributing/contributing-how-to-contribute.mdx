...
1. Fork the [idrflow GitHub repository](https://github.com/langflow-ai/langflow).
...
To run idrflow from source on Windows, you can use the idrflow repository's included scripts, or run the commands in the terminal.
...
2. Fork the [idrflow GitHub repository](https://github.com/langflow-ai/langflow).
