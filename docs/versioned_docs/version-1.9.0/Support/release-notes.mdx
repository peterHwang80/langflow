...
- idrflow MCP client for Bob (IBM) and Claude Code
    ...
    For more information, see [idrflow MCP client](../Agents/idrflow-mcp-client.mdx).
...
- Build components with **idrflow Assistant**
    ...
    **idrflow Assistant** is a graph-aware co-pilot that can create components from natural language prompts, directly within the idrflow workspace.
