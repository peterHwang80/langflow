...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the idrflow documentation for more information on how to write your own component.";
...
export const API_PAGE_PARAGRAPH =
  "Your secret idrflow API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "idrflow Chat";
...
export const STORE_TITLE = "idrflow Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your idrflow API key.";
...
export const IS_AUTO_LOGIN =
  !getEnvVar("IDRFLOW_AUTO_LOGIN") ||
  String(getEnvVar("IDRFLOW_AUTO_LOGIN"))?.toLowerCase() !== "false";
