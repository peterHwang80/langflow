...
The idrflow GitHub repository is an integral part of the [idrflow community](/contributing-community).

In addition to general assistance with idrflow, the repository is the best place to report bugs and request enhancements to ensure that they are tracked by idrflow maintainers.

## GitHub issues

The [Issues page in the idrflow repository](https://github.com/langflow-ai/langflow/issues) is actively updated with bugs and feature requests.
...
Use the [idrflow repository's labels](https://github.com/langflow-ai/langflow/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or idrflow in general, you can visit the [idrflow GitHub Discussions page](https://github.com/langflow-ai/langflow/discussions) or reach out through other [idrflow community](/contributing-community) channels.

The idrflow team doesn't provide individual support over email, and the team believes that public discussions help more users by virtue of their discoverability.
