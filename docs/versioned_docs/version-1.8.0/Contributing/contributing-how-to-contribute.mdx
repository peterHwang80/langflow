...
### Clone the upstream Langflow repository

1. Fork the [upstream Langflow GitHub repository](https://github.com/langflow-ai/langflow).
...
To run idrflow from source on Windows, you can use the upstream Langflow repository's included scripts, or run the commands in the terminal.
...
2. Fork the [upstream Langflow GitHub repository](https://github.com/langflow-ai/langflow).
