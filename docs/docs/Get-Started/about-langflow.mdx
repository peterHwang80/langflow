...
<Cards cols={3}>
  ...
  <Card icon={<Icon name="Cloud" size={20} />} title="Deploy" href="/deployment-overview">
    Deploy idrflow to production environments.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Zap" size={20} />} title="Trigger flows with the API" href="/concepts-publish">
    Use the idrflow API to run flows from your application code.
  </Card>
  <Card icon={<Icon name="Container" size={20} />} title="Containerize your app" href="/develop-application">
    Build and deploy idrflow as a containerized application.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Bot" size={20} />} title="idrflow Agents" href="/agents">
    Build and configure AI agents with idrflow.
  </Card>
  ...
  <Card icon={<Icon name="Plug" size={20} />} title="MCP server" href="/mcp-server">
    Expose idrflow as an MCP server.
  </Card>
  <Card icon={<Icon name="Cable" size={20} />} title="MCP client" href="/mcp-client">
    Connect idrflow to external MCP servers.
  </Card>
</Cards>
