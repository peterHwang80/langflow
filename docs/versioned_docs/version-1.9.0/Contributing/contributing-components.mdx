...
New components are added as objects of the [`Component`](http://218.50.209.93:9001/peter/idrflow/-/blob/main/src/lfx/src/lfx/custom/custom_component/component.py) class.

Dependencies are added to the [pyproject.toml](http://218.50.209.93:9001/peter/idrflow/-/blob/main/pyproject.toml) file.

## Contribute an example component to idrflow

Anyone can contribute an example component. For example, to create a new data component called **DataFrame processor**, follow these steps to contribute it to idrflow.
...
You can view the [/data/__init__.py](http://218.50.209.93:9001/peter/idrflow/-/blob/main/src/lfx/src/lfx/components/data/__init__.py) in the idrflow repository.

7. Add any new dependencies to the [pyproject.toml](http://218.50.209.93:9001/peter/idrflow/-/blob/main/pyproject.toml#L20) file.

8. Submit documentation for your component. For this example component, you would submit documentation to the [Data components page](http://218.50.209.93:9001/peter/idrflow/-/blob/main/docs/docs/Components/components-data.mdx).

9. Submit your changes as a merge request. The idrflow team will review, suggest changes, and add your component to idrflow.
...
When documenting changes in merge requests, clearly explain *what* changed, such as display name updates or new fields, *why* it changed, such as improvements or bug fixes, and the *impact* on existing users.

For example:

<details>
<summary>Example MR</summary>

```markdown
# Merge request with changes to Notify component

This merge request updates the Notify component.
