...
The **Smart Transform** component uses an LLM and natural language instructions to generate a Lambda function that can filter or transform [`Data`](/data-types#json), [`DataFrame`](/data-types#table), or [`Message`](/data-types#message) input.
...
The LLM runs the function against the input, and then outputs the results as [`Data`](/data-types#json), [`DataFrame`](/data-types#table), or [`Message`](/data-types#message).
...
|------|--------------|------|
| data | Data | Input parameter. The [`Data`](/data-types#json), [`DataFrame`](/data-types#table), or [`Message`](/data-types#message) input to filter or transform using the generated Lambda function. |
