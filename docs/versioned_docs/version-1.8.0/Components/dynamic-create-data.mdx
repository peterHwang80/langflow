...
The **Dynamic Create Data** component creates a [`Data`](/data-types#json) object or [`Message`](/data-types#message) with configurable fields.
...
5. Select the desired output type at the component's output port. The component outputs either a [`Data`](/data-types#json) object containing all field values from the component's inputs, or a [`Message`](/data-types#message) containing all field values formatted as a text string.
