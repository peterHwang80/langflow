...
1. Fork the [upstream Langflow repository](https://github.com/langflow-ai/langflow) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the upstream Langflow repository.
5. Include a screenshot of your template in the PR.

The idrflow team will review your PR, offer feedback, and, if approved, merge the template.
