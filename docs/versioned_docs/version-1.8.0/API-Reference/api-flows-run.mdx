...
url = "http://IDRFLOW_SERVER_URL/api/v1/run/FLOW_ID"
...
fetch('http://IDRFLOW_SERVER_URL/api/v1/run/FLOW_ID', options)
...
url = "http://IDRFLOW_SERVER_URL/api/v1/run/FLOW_ID?stream=true"
...
fetch('http://IDRFLOW_SERVER_URL/api/v1/run/FLOW_ID?stream=true', options)
  .then(async response => {
