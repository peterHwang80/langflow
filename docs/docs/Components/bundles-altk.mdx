...
:::tip
The ALTK contains features called _components_. These are different from idrflow components. All components within ALTK are available through idrflow's **ALTK Agent** component.
:::
...
For an example of the ALTK component in idrflow, see the video tutorial [ALTK in idrflow: Reliably handle JSON responses in your AI agent](https://www.youtube.com/watch?v=YNwPBK_KxXY).
