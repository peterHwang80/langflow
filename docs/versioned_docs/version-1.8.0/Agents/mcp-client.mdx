...
| response | DataFrame | Output parameter. [`DataFrame`](/data-types#table) containing the response from the executed tool. |

## Manage connected MCP servers

To manage all MCP server connections for your idrflow client, click <McpIcon /> **MCP servers** in the visual editor, or click your profile icon, select **Settings**, and then click **MCP Servers**.
...
5. To manage MCP server connections for your idrflow client, click <McpIcon /> **MCP servers** in the visual editor, or click your profile icon, select **Settings**, and then click **MCP Servers**.
