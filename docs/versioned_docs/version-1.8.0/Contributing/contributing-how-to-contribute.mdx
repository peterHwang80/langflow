...
> Note: The canonical source for idrflow is the GitLab-hosted idrflow repository or your team's GitLab fork. Use upstream compatibility references only when you need runtime-level historical context.
