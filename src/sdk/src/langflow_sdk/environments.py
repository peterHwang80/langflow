...
3. ``idrflow-environments.toml`` in the current working directory.
4. ``~/.config/idrflow/environments.toml``
...
.. code-block:: toml
    ...
    api_key_env = "IDRFLOW_STAGING_API_KEY"   # env-var that holds the key  # pragma: allowlist secret

    [environments.production]
    url = "https://langflow.example.com"
    api_key_env = "IDRFLOW_PROD_API_KEY"  # pragma: allowlist secret
...
_ENV_VAR = "IDRFLOW_ENVIRONMENTS_FILE"
_LOCAL_NAME = "idrflow-environments.toml"
_USER_PATH = Path.home() / ".config" / "idrflow" / "environments.toml"
...
# [environments.staging]
# url = "https://staging.langflow.example.com"
# api_key_env = "IDRFLOW_STAGING_API_KEY"  # pragma: allowlist secret
#
# [environments.production]
# url = "https://langflow.example.com"
# api_key_env = "IDRFLOW_PROD_API_KEY"  # pragma: allowlist secret
...
def load_environments(
    ...
    ----------
    config_file:
        Explicit path to a ``idrflow-environments.toml`` file. If omitted,
    ...
    if file_path is None:
        raise EnvironmentConfigError(
            "No idrflow-environments.toml found. "
