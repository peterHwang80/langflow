...
1. Follow this link to launch the Cloud Shell with the GCP deployment script from the idrflow repository:
...
3. Click **Start**, and then follow the tutorial to deploy idrflow.
