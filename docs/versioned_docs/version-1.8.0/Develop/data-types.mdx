...
The schema is defined in [`data.py`](http://218.50.209.93:9001/peter/idrflow/-/blob/main/src/backend/base/langflow/schema/data.py).
...
The schema is defined in [`dataframe.py`](http://218.50.209.93:9001/peter/idrflow/-/blob/main/src/backend/base/langflow/schema/dataframe.py).

The following attributes are available:

- **Full pandas compatibility**: All pandas DataFrame methods and functionality are supported

- **idrflow integration**: Accepts lists of [`Data` objects](#data), dictionaries, or existing DataFrames.
...
The `Message` schema is defined in [`message.py`](http://218.50.209.93:9001/peter/idrflow/-/blob/main/src/backend/base/langflow/schema/message.py).
