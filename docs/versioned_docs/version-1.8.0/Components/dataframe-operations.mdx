...
The **DataFrame Operations** component performs operations on [`DataFrame`](/data-types#table) (table) rows and columns, including schema changes, record changes, sorting, and filtering.
