...
- Create a [idrflow API key](/api-keys-and-authentication)
    ...
    5. To use your idrflow API key in a request, set a `LANGFLOW_API_KEY` environment variable in your terminal, and then include an `x-api-key` header or query parameter with your request.
    For example:
