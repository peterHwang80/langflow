...
For template formatting examples, see [`/starter_projects`](http://218.50.209.93:9001/peter/idrflow/-/tree/main/src/backend/base/langflow/initial_setup/starter_projects) in the idrflow repository.
...
For more information, see the idrflow repository's [template categories](http://218.50.209.93:9001/peter/idrflow/-/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).
