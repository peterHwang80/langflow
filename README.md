...
> **Canonical repository:** idrflow is now maintained from the internal GitLab repository at `http://218.50.209.93:9001/peter/idrflow.git`. GitLab is the sole operational source of truth for repository management.
>
...
Contributions are welcome. See [CONTRIBUTING.md](./CONTRIBUTING.md) for GitLab merge request and issue workflow guidance, and follow the GitLab-based issue and merge request workflow for all repository work.
