...
For template formatting examples, see [`/starter_projects`](https://github.com/langflow-ai/langflow/tree/main/src/backend/base/langflow/initial_setup/starter_projects) in the idrflow repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [idrflow repository](https://github.com/langflow-ai/langflow) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main idrflow repository.
...
For more information, see the idrflow repository's [template categories](https://github.com/langflow-ai/langflow/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).